...
export const registrationCopy = {
  nl: {
    ...
    eyebrow: "Begin met Geregeld",
    title: "Maak je gebruiker aan.",
    description:
      "Geen wachtwoord. We sturen een eenmalige code naar je e-mailadres.",
  ...
  en: {
    ...
    eyebrow: "Start with Geregeld",
    title: "Create your user.",
    description: "No password. We’ll send a one-time code to your email.",
